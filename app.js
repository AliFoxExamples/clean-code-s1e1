...
var createNewTaskElement = function (taskString) {
    ...
    editInput.type = "text";
    editInput.classList.add("task-input", "task-input_hide");
...
var editTask = function () {
    ...
    label.classList.toggle("list-item__label_hide");
    editInput.classList.toggle("task-input_hide");
...
var taskCompleted = function () {
    ...
    listItem.querySelector(".list-item__label").classList.add("list-item__label_completed");
...
var taskIncomplete = function () {
    ...
    var listItem = this.parentNode;
    incompleteTaskHolder.appendChild(listItem);
    listItem.querySelector(".list-item__label").classList.remove("list-item__label_completed");
    bindTaskEvents(listItem, taskCompleted);
}
